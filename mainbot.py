...
while True:
    user = api.get_user('KarunaP82836735')
    api.update_profile(name=f'KARUNA|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : KARUNA|{follower_count(user)} Followers')
